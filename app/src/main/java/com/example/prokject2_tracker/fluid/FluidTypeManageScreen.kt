...
import com.example.prokject2_tracker.core.ui.ColorSwatchPicker
...
// The colour picker itself now lives in core/ui/ColorSwatchPicker.kt — the Tags library picks from
// the same palette, and a second copy would be a second thing to keep in step.
