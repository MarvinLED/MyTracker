 ...
 * preference ([com.example.prokject2_tracker.core.datastore.WeightUnit]) — only read paths convert.
 * Deterministic id ("weight-$epochDay") + upsert-on-conflict makes logging idempotent, mirroring
 * [com.example.prokject2_tracker.habit.HabitCheckIn]'s one-entry-per-day convention. Tracked/logged
 * data, never exported.
 */
